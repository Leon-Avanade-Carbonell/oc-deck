 ...
 *
 * Animation controls panel for the 3D flights map (/flights/3dmap).
 * Provides play/pause, timeline scrubber, speed multiplier, and trail length.
 *
 * Intentionally separate from FlightsAnimationControls so the 3D experience
 * can evolve independently (e.g. adding altitude scale tuning, vertical rate
 * legend, or other 3D-specific controls).
 */
export function Flights3DAnimationControls() {
